(function() {
     ...
     */
    describe('directive nav-lateralen', function() {
      // var $window;
      var vm;
      var el;
      var timeInMs;
  
      beforeEach(module('kriptoRedeem'));
      beforeEach(inject(function($compile, $rootScope) {
        ...
        el = angular.element('<nav-lateralen(function() {
    'use strict';
    ...
    describe('directive nav-lateralen', function() {
      ...
      beforeEach(inject(function($compile, $rootScope) {
        ...
        el = angular.element('<nav-lateralen creation-date="' + timeInMs + '"></nav-lateralen>');
   ...
   creation-date="' + timeInMs + '"></nav-lateralen>');
